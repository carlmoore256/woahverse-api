...
const handleNonce: Handler = (req, res) => {
...
export default (parent: Router) => {
    ...
    router.get("/nonce/:address", handleNonce);
    ...
    router.post(
        ...
        body("address")
            ...
            .isEthereumAddress()
            .withMessage("Address is not a valid ethereum address"),
        body("signature")
            .notEmpty()
    ...
    router.get("/is-authenticated", authenticateJWTWithCookies, (req, res) => {
